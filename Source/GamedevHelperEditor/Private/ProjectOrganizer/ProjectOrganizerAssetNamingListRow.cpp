...
void SProjectOrganizerAssetNamingListRow::Construct(const FArguments& InArgs, const TSharedRef<STableViewBase>& InOwnerTableView)
{
	RowItem = InArgs._RowItem;

	SMultiColumnTableRow<TWeakObjectPtr<UProjectOrganizerAssetNamingListRowData>>::Construct(
		SMultiColumnTableRow<TWeakObjectPtr<UProjectOrganizerAssetNamingListRowData>>::FArguments()
...
TSharedRef<SWidget> SProjectOrganizerAssetNamingListRow::GenerateWidgetForColumn(const FName& InColumnName)
{
