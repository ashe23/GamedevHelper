...
public:
	...
	/**
	 * @brief Creates a new random string by given Len, Charset and Seed. By default Seed is zero,
	 * that will generate new seed every time internally.
	 * @param Len int32
	...
	/**
	 * @brief Returns difference of character sets of given two string , set of all elements that
	 * are members of StringA, but not members of StringB
	 * - "", "" => ""
	 * - "abc", "abd" => "a"
	 * - "abc", "def" => "abc"
	 * @param StringA FString
	...
	/**
	 * @brief Returns symmetric difference of character sets of given two string. Returns the
	 * elements that are unique to SetA or SetB, but not common to both.
	 * - "", "" => ""
	 * - "", "abc" => "abc"
	 * - "abc", "abc" => ""
	 * - "abc", "def" => "abcdef"
	...
	/**
	 * @brief Returns normalized string by removing all extra underscores and hyphens from string
	 * start and end, then replaces by underscore in the middle of string
	 * - "_aa_" => "aa"
	 * - "aaa" => "aaa"
	...
	/**
	 * @brief Returns new string with contextual parts splitted by underscore. String can be in any
	 * naming case, even mixed.
	...
	/**
	 * @brief Converts string to UPPERCASE, but this is tokenized version. For simple conversions
	 * use ToUpper
	 * @param Str FString
	 * @return FString
	 */
	...
	/**
	 * @brief Converts string to lowercase, but this is tokenized version. For simple conversions
	 * use ToLower
	 * @param Str FString
	 * @return FString
	 */
