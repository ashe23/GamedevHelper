...
bool FGdhLibPath::RunTest(const FString& Parameters) {
	...
	TestEqual(
		TEXT("Normalize path starting with slash"),
		UGdhLibPath::Normalize(TEXT("/User/Documents")),
		TEXT("C:/User/Documents")
	);	 // Adjust expected output based on your logic

	// Test case 3: Path starts with backslash
	TestEqual(
		TEXT("Normalize path starting with backslash"),
		UGdhLibPath::Normalize(TEXT("\\User\\Documents")),
		TEXT("C:/User/Documents")
	);	 // Adjust expected output based on your logic
	...
	TestEqual(
		TEXT("Normalize relative path"),
		UGdhLibPath::Normalize(TEXT("../Documents")),
		TEXT("C:/User/Documents")
	...
	// TestEqual(TEXT("Duplicate Slashes"), UGdhLibPath::Normalize(TEXT("/Folder//AnotherFolder")),
	// TEXT("/Folder/AnotherFolder")); TestEqual(TEXT("Ending With Slash"),
	// UGdhLibPath::Normalize(TEXT("/Folder/")), TEXT("/Folder")); TestEqual(TEXT("No Whitespaces"),
	// UGdhLibPath::Normalize(TEXT(" /Folder/ ")), TEXT(""));
