...
public:
	...
	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|AntiAliasing", DisplayName="Use AA settings")
	bool bSettingsAAEnabled = false;
	
	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|AntiAliasing", meta = (UIMin = 1, ClampMin = 1, EditCondition="bSettingsAAEnabled"))
	int32 SpatialSampleCount = 1;

	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|AntiAliasing", meta = (UIMin = 1, ClampMin = 1, EditCondition="bSettingsAAEnabled"))
	int32 TemporalSampleCount = 1;
	
	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|AntiAliasing", meta = (EditCondition="bSettingsAAEnabled"))
	bool bOverrideAntiAliasing = false;
	
	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|AntiAliasing", meta = (EditCondition="bOverrideAntiAliasing && bSettingsAAEnabled"))
	TEnumAsByte<EAntiAliasingMethod> AntiAliasingMethod = AAM_None;

	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|AntiAliasing", meta = (UIMin = 0, ClampMin = 0, EditCondition="bSettingsAAEnabled"), AdvancedDisplay)
	int32 RenderWarmUpCount = 32;
	
	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|AntiAliasing", meta = (EditCondition="bSettingsAAEnabled"))
	bool bUseCameraCutForWarmUp = false;

	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|AntiAliasing", meta = (UIMin = 0, ClampMin = 0, EditCondition="!bUseCameraCutForWarmUp && bSettingsAAEnabled"), AdvancedDisplay)
	int32 EngineWarmUpCount = 0;

	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|AntiAliasing", meta = (EditCondition="bSettingsAAEnabled"))
	bool bRenderWarmUpFrames = false;

	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|ConsoleVariables", DisplayName="Use Console Variables Settings")
	bool bSettingsConsoleVariablesEnabled = false;
	
	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|ConsoleVariables", meta = (EditCondition="bSettingsConsoleVariablesEnabled"))
	...
	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|GameOverride", DisplayName="Use GameOverride Settings")
	bool bSettingsGameOverrideEnabled = false;

	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|GameOverride|Game", meta = (EditCondition="bSettingsGameOverrideEnabled"))
	TSubclassOf<AGameModeBase> GameModeOverride = AMoviePipelineGameMode::StaticClass();

	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|GameOverride|Game", meta = (EditCondition="bSettingsGameOverrideEnabled"))
	bool bCinematicQualitySettings = true;

	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|GameOverride|Rendering", meta = (EditCondition="bSettingsGameOverrideEnabled"))
	...
	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|GameOverride|Rendering", meta = (EditCondition="bUseHighQualityShadows && bSettingsGameOverrideEnabled", ClampMin=0.1, UIMin=0.1, UIMax=10))
	int32 ShadowDistanceScale = 10;

	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|GameOverride|Rendering", meta = (EditCondition="bUseHighQualityShadows && bSettingsGameOverrideEnabled", UIMin=0.001, ClampMin=0.001))
	float ShadowRadiusThreshold = 0.001f;

	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|GameOverride|Rendering", meta = (EditCondition="bSettingsGameOverrideEnabled"))
	bool bOverrideViewDistanceScale = true;

	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|GameOverride|Rendering", meta = (EditCondition="bOverrideViewDistanceScale && bSettingsGameOverrideEnabled"))
	int32 ViewDistanceScale = 50;
	
	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|GameOverride|Rendering", meta = (EditCondition="bSettingsGameOverrideEnabled"))
	bool bFlushGrassStreaming = true;

	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|UI Renderer", DisplayName="Use UI Settings")
	bool bSettingsUIEnabled = false;

	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|UI Renderer", meta = (MetaClass = "MoviePipelineBurnInWidget", EditCondition="bSettingsUIEnabled"))
	bool bCompositeOntoFinalImage = true;

	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|BurnIn", DisplayName="Use BurnIn Settings")
	bool bSettingsBurnInEnabled = false;

	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|BurnIn", meta = (MetaClass="MoviePipelineBurnInWidget", EditCondition="bSettingsBurnInEnabled"))
	FSoftClassPath BurnInClass = UMoviePipelineBurnInSetting::DefaultBurnInWidgetAsset;

	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|BurnIn", meta = (MetaClass="MoviePipelineBurnInWidget", EditCondition="bSettingsBurnInEnabled"))
	bool bBurnInCompositeOntoFinalImage = true;

	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|Camera Settings", DisplayName="Use Camera Settings")
	bool bSettingsCameraEnabled = false;

	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|Camera Settings", meta = (EditCondition="bSettingsCameraEnabled"))
	EMoviePipelineShutterTiming ShutterTiming = EMoviePipelineShutterTiming::FrameCenter;

	UPROPERTY(EditAnywhere, Config, BlueprintReadWrite, Category = "MovieRenderSettings|Camera Settings", meta = (EditCondition="bSettingsCameraEnabled",UIMin=0, UIMax=1, ClampMin=0, ClampMax=1))
