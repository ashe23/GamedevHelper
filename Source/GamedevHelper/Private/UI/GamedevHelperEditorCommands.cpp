...
void FGamedevHelperEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND(Cmd_RenderingManageOpenImagesFolder, "Open Images Folder", "Open Images folder for selected job", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(Cmd_RenderingManageOpenVideoFolder, "Open Video Folder", "Open Video folder for selected job", EUserInterfaceActionType::Button, FInputChord());
