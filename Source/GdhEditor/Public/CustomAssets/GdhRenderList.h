...
#include "GdhRenderList.generated.h"

/**
 * UGdhRenderList
 *
 * A custom Unreal Engine asset type designed to store and manage a batch of Level Sequences
 * for rendering purposes. This asset allows users to organize multiple sequences and execute batch rendering
 * efficiently. It is primarily used to streamline the process of generating rendered images for cinematic sequences.
 *
 * Features:
...
class GDHEDITOR_API UGdhRenderList : public UObject
{
public:
