...
TSharedRef<FSlateStyleSet> FGdhStyles::Create()
{
	...
	Style->Set("GamedevHelper.OpenVideoEncoderTool", new IMAGE_BRUSH(TEXT("IconRender32"), FVector2D{32.0f, 32.0f}));
	Style->Set("GamedevHelper.OpenVideoEncoderTool.Small", new IMAGE_BRUSH(TEXT("IconRender20"), FVector2D{20.0f, 20.0f}));
	...
	Style->Set("GamedevHelper.ScanActors", new IMAGE_BRUSH(TEXT("IconRefresh32"), FVector2D{32.0f, 32.0f}));
	Style->Set("GamedevHelper.ScanActors.Small", new IMAGE_BRUSH(TEXT("IconRefresh20"), FVector2D{20.0f, 20.0f}));
	Style->Set("GamedevHelper.OrganizeActors", new IMAGE_BRUSH(TEXT("IconOrganize32"), FVector2D{32.0f, 32.0f}));
	Style->Set("GamedevHelper.OrganizeActors.Small", new IMAGE_BRUSH(TEXT("IconOrganize20"), FVector2D{20.0f, 20.0f}));
	Style->Set("GamedevHelper.RenameActors", new IMAGE_BRUSH(TEXT("IconRename32"), FVector2D{32.0f, 32.0f}));
	Style->Set("GamedevHelper.RenameActors.Small", new IMAGE_BRUSH(TEXT("IconRename20"), FVector2D{20.0f, 20.0f}));
	...
	Style->Set("GamedevHelper.Tab.VideoEncoderTool", new IMAGE_BRUSH(TEXT("IconRender20"), FVector2D{16.0f, 16.0f}));
