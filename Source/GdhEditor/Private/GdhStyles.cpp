...
TSharedRef<FSlateStyleSet> FGdhStyles::Create() {
	...
	Style->Set("GamedevHelper.OpenActorNamingTool", new IMAGE_BRUSH(TEXT("IconOrganize32"), FVector2D {32.0f, 32.0f}));
	Style->Set("GamedevHelper.OpenActorNamingTool.Small", new IMAGE_BRUSH(TEXT("IconOrganize20"), FVector2D {20.0f, 20.0f}));
	Style->Set("GamedevHelper.OpenBatchEncodeTool", new IMAGE_BRUSH(TEXT("IconRender32"), FVector2D {32.0f, 32.0f}));
	Style->Set("GamedevHelper.OpenBatchEncodeTool.Small", new IMAGE_BRUSH(TEXT("IconRender20"), FVector2D {20.0f, 20.0f}));

	// Asset Naming Tool Cmds
	...
	Style->Set("GamedevHelper.ApplyChanges.Small", new IMAGE_BRUSH(TEXT("IconCheck32"), FVector2D {20.0f, 20.0f}));
	...
	// Actor Naming Tool Cmds
	Style->Set("GamedevHelper.AntScanActors", new IMAGE_BRUSH(TEXT("IconRefresh32"), FVector2D {32.0f, 32.0f}));
	Style->Set("GamedevHelper.AntScanActors.Small", new IMAGE_BRUSH(TEXT("IconRefresh20"), FVector2D {20.0f, 20.0f}));
	Style->Set("GamedevHelper.AntOrganizeActors", new IMAGE_BRUSH(TEXT("IconOrganize32"), FVector2D {32.0f, 32.0f}));
	Style->Set("GamedevHelper.AntOrganizeActors.Small", new IMAGE_BRUSH(TEXT("IconOrganize20"), FVector2D {20.0f, 20.0f}));
	Style->Set("GamedevHelper.AntRenameActors", new IMAGE_BRUSH(TEXT("IconRename32"), FVector2D {32.0f, 32.0f}));
	Style->Set("GamedevHelper.AntRenameActors.Small", new IMAGE_BRUSH(TEXT("IconRename20"), FVector2D {20.0f, 20.0f}));
	Style->Set("GamedevHelper.AntUndoAction", new IMAGE_BRUSH(TEXT("IconUndo32"), FVector2D {32.0f, 32.0f}));
	Style->Set("GamedevHelper.AntUndoAction.Small", new IMAGE_BRUSH(TEXT("IconUndo20"), FVector2D {20.0f, 20.0f}));

	// Batch Encode Tool Cmds
	Style->Set("GamedevHelper.BetRefresh", new IMAGE_BRUSH(TEXT("IconRefresh32"), FVector2D {32.0f, 32.0f}));
	Style->Set("GamedevHelper.BetRefresh.Small", new IMAGE_BRUSH(TEXT("IconRefresh20"), FVector2D {20.0f, 20.0f}));
	Style->Set("GamedevHelper.BetProcess", new IMAGE_BRUSH(TEXT("IconPlay32"), FVector2D {32.0f, 32.0f}));
	Style->Set("GamedevHelper.BetProcess.Small", new IMAGE_BRUSH(TEXT("IconPlay20"), FVector2D {20.0f, 20.0f}));
	Style->Set("GamedevHelper.BetRenderListRefresh", new IMAGE_BRUSH(TEXT("IconRefresh32"), FVector2D {32.0f, 32.0f}));
	Style->Set("GamedevHelper.BetRenderListRefresh.Small", new IMAGE_BRUSH(TEXT("IconRefresh20"), FVector2D {20.0f, 20.0f}));
	Style->Set("GamedevHelper.BetRenderListRemove", new IMAGE_BRUSH(TEXT("IconDelete32"), FVector2D {32.0f, 32.0f}));
	...
	Style->Set("GamedevHelper.Tab.BatchEncodeTool", new IMAGE_BRUSH(TEXT("IconRender20"), FVector2D {16.0f, 16.0f}));
