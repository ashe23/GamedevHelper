...
#include "GamedevHelperCoreAssetLibrary.generated.h"

UCLASS()
class GAMEDEVHELPERCORE_API UGamedevHelperAssetLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
public:
	/**
	...
	static void VertexAnimToolConfigureTexture(const TArray<FAssetData>& Assets, const EGDHVertexAnimToolTextureType TextureType);
