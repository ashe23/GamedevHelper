...
void FGdhCommands::RegisterCommands()
{
	...
	UI_COMMAND(RenameAssets, "Rename Assets", "Rename selected assets", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(ScanAssets, "Scan Assets", "Scan project assets", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(ClearSelection, "Clear Selection", "Clear any selection", EUserInterfaceActionType::Button, FInputChord());
